...
import {
  ...
  setTwoToneColor,
  warning_default
} from "./chunk-OY3ORKMC.js";
import {
  require_react_dom
} from "./chunk-DVUV257Z.js";
import {
  require_react
} from "./chunk-T4Y5KGCI.js";
import {
  __commonJS,
  __toESM
...
var require_es6_symbol = __commonJS({
  "node_modules/core-js/library/modules/es6.symbol.js"() {
    ...
    var $getOwnPropertyNames = function getOwnPropertyNames(it) {
      ...
      var key;
      while (names.length > i) {
        if (!has2(AllSymbols, key = names[i++]) && key != HIDDEN && key != META)
          result.push(key);
      }
      return result;
    };
    var $getOwnPropertySymbols = function getOwnPropertySymbols(it) {
      ...
      var key;
      while (names.length > i) {
        if (has2(AllSymbols, key = names[i++]) && (IS_OP ? has2(ObjectProto, key) : true))
...
var genSharedButtonStyle = function genSharedButtonStyle2(token) {
  ...
  return _defineProperty({}, componentCls, _objectSpread(_objectSpread({}, resetComponent(token)), {}, (_objectSpread22 = {
    position: "relative",
    backgroundColor: colorBgContainer
  }, _defineProperty(_objectSpread22, "".concat(componentCls, "-inner"), {
    display: "flex",
    paddingBlock: padding
  }), _defineProperty(_objectSpread22, "".concat(componentCls, "-avatar"), {
    position: "relative",
    flexShrink: 0,
  ...
  }), _defineProperty(_objectSpread22, "".concat(componentCls, "-content"), {
    position: "relative",
    flex: "auto",
    minWidth: 0,
    wordWrap: "break-word",
  ...
  }), _defineProperty(_objectSpread22, "".concat(componentCls, "-actions"), {
    marginTop: marginSM,
    marginBottom: 0,
  ...
  }), _defineProperty(_objectSpread22, "".concat(componentCls, "-nested"), {
...
function computedStyle(el, prop) {
  ...
  var style = getComputedStyle2 ? getComputedStyle2(el) : el.currentStyle;
  if (style) {
...
var FormItem = function(_React$Component) {
  ...
  function FormItem2() {
    ...
    _defineProperty5(_assertThisInitialized(_this), "renderFormItem", function(_ref) {
      ...
      var itemClassName = (_itemClassName = {}, _defineProperty5(_itemClassName, "".concat(prefixCls, "-item"), true), _defineProperty5(_itemClassName, "".concat(prefixCls, "-item-with-help"), _this.helpShow), _defineProperty5(_itemClassName, "".concat(className), !!className), _itemClassName);
  ...
  _createClass3(FormItem2, [{
    ...
    value: function renderLabel(prefixCls) {
      ...
      return React7.createElement(context_default.Consumer, {
        ...
        var labelClassName = (0, import_classnames2.default)((_classNames = {}, _defineProperty5(_classNames, "".concat(prefixCls, "-item-required"), required), _defineProperty5(_classNames, "".concat(prefixCls, "-item-no-colon"), !computedColon), _classNames));
...
var resetForm = function resetForm2(token) {
  ...
  }, _defineProperty6(_ref, "input[type='search']", {
    boxSizing: "border-box"
  }), _defineProperty6(_ref, "input[type='radio'], input[type='checkbox']", {
    lineHeight: "normal"
  }), _defineProperty6(_ref, "input[type='file']", {
    display: "block"
  }), _defineProperty6(_ref, "input[type='range']", {
    display: "block",
    width: "100%"
  }), _defineProperty6(_ref, "select[multiple], select[size]", {
    height: "auto"
  }), _defineProperty6(_ref, "input[type='file']:focus, input[type='radio']:focus, input[type='checkbox']:focus", [{
    outline: "thin dotted"
  }, {
    outline: "5px auto -webkit-focus-ring-color",
    outlineOffset: "-2px"
  }]), _defineProperty6(_ref, "output", {
    display: "block",
    paddingTop: "15px",
    color: colorText,
    fontSize,
...
var genVerticalLayout = function genVerticalLayout2(token) {
  ...
  return _ref = {}, _defineProperty7(_ref, "".concat(componentCls, "-item-label, ").concat(componentCls, "-item-control-wrapper"), {
    display: "block",
    width: "100%"
  }), _defineProperty7(_ref, "".concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token))), _defineProperty7(_ref, "".concat(componentCls, "-item-control-wrapper"), _objectSpread2({}, genVerticalLayoutControlWrapper())), _ref;
};
var genFormLayoutStyle = function genFormLayoutStyle2(token) {
  var _$concat, _componentCls, _ref2, _$concat3;
  ...
  return [
    (_ref2 = {}, _defineProperty7(_ref2, componentCls, (_componentCls = {}, _defineProperty7(_componentCls, "\n        &".concat(componentCls, "-vertical ").concat(componentCls, "-item-label,\n        ").concat(antCls, "-col-24").concat(componentCls, "-item-label,\n        ").concat(antCls, "-col-xl-24").concat(componentCls, "-item-label\n      "), _objectSpread2({}, genVerticalLayoutLabel(token))), _defineProperty7(_componentCls, "".concat(componentCls, "-vertical"), (_$concat = {}, _defineProperty7(_$concat, "".concat(componentCls, "-item"), {
      paddingBottom: "8px"
    }), _defineProperty7(_$concat, "".concat(componentCls, "-item-control"), {
      lineHeight
    }), _defineProperty7(_$concat, "".concat(componentCls, "-explain"), {
      marginTop: 2,
      marginBottom: "-4px -".concat(formExplainPrecision, "px")
    }), _defineProperty7(_$concat, "".concat(componentCls, "-extra"), {
      marginTop: 2,
      marginBottom: -4
    }), _$concat)), _componentCls)), _defineProperty7(_ref2, "@media (max-width: ".concat(token.screenXSMax, ")"), _objectSpread2(_objectSpread2({}, genVerticalLayout(token)), {}, _defineProperty7({}, "".concat(antCls, "-col-xs-24").concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token))))), _defineProperty7(_ref2, "@media (max-width: ".concat(token.screenSMMax, ")"), _defineProperty7({}, "".concat(antCls, "-col-sm-24").concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token)))), _defineProperty7(_ref2, "@media (max-width: ".concat(token.screenMDMax, ")"), _defineProperty7({}, "".concat(antCls, "-col-md-24").concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token)))), _defineProperty7(_ref2, "@media (max-width: ".concat(token.screenLGMax, ")"), _defineProperty7({}, "".concat(antCls, "-col-lg-24").concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token)))), _defineProperty7(_ref2, "@media (max-width: ".concat(token.screenXLMax, ")"), _defineProperty7({}, "".concat(antCls, "-col-xl-24").concat(componentCls, "-item-label"), _objectSpread2({}, genVerticalLayoutLabel(token)))), _ref2),
    _defineProperty7({}, "".concat(componentCls, "-inline"), (_$concat3 = {}, _defineProperty7(_$concat3, "".concat(componentCls, "-item"), _defineProperty7({
      display: "inline-block",
      marginRight: "16px",
      marginBottom: "0",
      "&-with-help": {
      ...
      display: "inline-block",
      verticalAlign: "top"
    })), _defineProperty7(_$concat3, "".concat(componentCls, "-text"), {
      display: "inline-block"
    }), _defineProperty7(_$concat3, ".has-feedback", {
      display: "inline-block"
    }), _$concat3))
  ];
};
...
var genFeedbackStyle = function genFeedbackStyle2(token) {
  ...
  return _defineProperty8({}, componentCls, (_componentCls = {}, _defineProperty8(_componentCls, "".concat(componentCls, "-item-feedback-icon-success"), {
    color: colorSuccess
  }), _defineProperty8(_componentCls, "".concat(componentCls, "-item-feedback-icon-validating"), {
    color: colorInfo
  }), _defineProperty8(_componentCls, "".concat(componentCls, "-item-feedback-icon-warning"), {
    color: colorWarning
  }), _defineProperty8(_componentCls, "".concat(componentCls, "-item-feedback-icon-error"), {
    color: colorError
  }), _defineProperty8(_componentCls, ".has-warning", _objectSpread3({}, genFormControlValidation(componentCls, colorWarning))), _defineProperty8(_componentCls, ".has-error", _objectSpread3({}, genFormControlValidation(componentCls, colorError))), _componentCls));
};
...
var genFormStyle = function genFormStyle2(token) {
  ...
  return _defineProperty9({}, componentCls, _objectSpread4(_objectSpread4(_objectSpread4({}, resetComponent(token)), resetForm(token)), {}, (_objectSpread32 = {}, _defineProperty9(_objectSpread32, "".concat(componentCls, "-item-required::before"), {
    display: "inline-block",
    marginRight: 4,
    ...
    lineHeight: 1,
    content: '" * "'
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-hide-required-mark ").concat(componentCls, "-item-required::before"), {
    display: "none"
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-item-label > label"), {
  ...
  }), _defineProperty9(_objectSpread32, "&".concat(componentCls, "-item-no-colon::after"), {
    content: " "
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-item"), _objectSpread4(_objectSpread4({
    ...
    margin: "2px 0 4px"
  }))), _defineProperty9(_objectSpread32, "".concat(componentCls, "-explain, ").concat(componentCls, "-extra"), {
    clear: "both",
  ...
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-explain"), {
    marginBottom: -formExplainPrecision
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-extra"), {
    paddingTop: paddingXXS
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-text"), {
    display: "inline-block",
    paddingRight: paddingXS
  }), _defineProperty9(_objectSpread32, "".concat(componentCls, "-split"), {
    display: "block",
    textAlign: "center"
  }), _objectSpread32)));
};
...
var Form = function(_React$Component) {
  ...
  function Form2(props) {
    ...
    _defineProperty10(_assertThisInitialized2(_this), "renderForm", function(_ref) {
      ...
      var prefixCls = getPrefixCls("legacy-form", customizePrefixCls);
      var formClassName = (0, import_classnames3.default)(prefixCls, (_classNames = {}, _defineProperty10(_classNames, "".concat(prefixCls, "-horizontal"), layout === "horizontal"), _defineProperty10(_classNames, "".concat(prefixCls, "-vertical"), layout === "vertical"), _defineProperty10(_classNames, "".concat(prefixCls, "-inline"), layout === "inline"), _defineProperty10(_classNames, "".concat(prefixCls, "-hide-required-mark"), hideRequiredMark), _classNames), className);
